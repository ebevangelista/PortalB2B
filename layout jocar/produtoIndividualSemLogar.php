<?php include 'headerSemLogar.php' ?>
	...
	<div id="divBreadcrumbs" class="row">
		...
		<div class="col-md-4 text-center-sm"><a href="">Início</a> > <a href="">Pintura</a> > <a href="">Econômica</a> > <strong>KIT LÂMPADA DO FAROL - CERTA - H4 - 12V 60/55W</strong></div>
	...
	<div class="row">
		...
		<div class="col-md-5 text-center-sm">
			<h1>KIT LÂMPADA DO FAROL - CERTA - H4 - 12V 60/55W</h1>
			...
			<center>
				<button type="button" class="btn btn-primary btn-lg btn-block text-center btnProdutoFull">
				<img class="text-center" src="img/icon/digital.png" height="20" width="20">&nbsp;<strong>REGISTRAR-SE</strong><BR>PARA COMPRAR
				</button>
			</center>
		</div>
		<div class="col-md-3">
			<div class="row">
					...
					<div class="col-md-12">
						...
						<h4>KIT LÂMPADA DO FAROL - CERTA - H4 - 12V 60/55W</h4></a>

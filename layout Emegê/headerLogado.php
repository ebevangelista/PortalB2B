  ...
  <body>
	...
	<div id="divMenuLogotipo" class="container-fluid">
		<div class="row">
			<div class="col-md-1"></div>
			<div class="col-md-2 text-center">
				<a href="telainiciallogado.php"><img id="divImgLogotipo" src="img/logotipo.png" alt="" class="img-rounded" width="120" height="112"></a>
			</div>
				...
				<div class="btn-group" role="group">
					<div id="dropdownCarrinho" class="btn-group dropdown" role="group">
					  ...
					  <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
						<li>
							<small>
							<strong>FARINHA DE TRIGO EMEGÊ</strong><br>
							R$ 48,00 x 5 UN
							</small>
						</li>
						<li>
